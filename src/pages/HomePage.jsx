...
import { AboutSection, ActualSection, ActualSection2, ContactSection, NewsSection, PopularSection, PostPreview, PostPreview2, PromoSection, VisualSection } from "../Home Sections";
...
const HomePage = () => {
  ...
  return (
    <>
      ...
      <aside
        className={`top-0 right-0 w-[80%] ease-linear duration-200 bg-white text-black fixed h-full z-40 lg:hidden ${
      ...
      {/* END OF MENU DIV FOR DESKTOP VERSION */}
      <main
      ...
      >
        ...
        <div className="slider">
          <div className="slide-track">
            ...
            <div className="slide">
              <img
                src="https://nauticaereso.com/wp-content/uploads/2023/01/img-partner-01.svg"
                alt="jeaneeau logo"
              />
            </div>
            <div className="slide">
              <img
                src="https://nauticaereso.com/wp-content/uploads/2023/01/img-partner-02.svg"
                alt="zodiac logo"
              />
            </div>
            <div className="slide">
              <img
                src="https://nauticaereso.com/wp-content/uploads/2023/01/img-partner-05.svg"
                alt="pacific logo"
              />
            </div>
            <div className="slide">
              <img
                src="https://nauticaereso.com/wp-content/uploads/2023/01/img-partner-03.svg"
                alt="lomac logo"
              />
            </div>
            <div className="slide">
              <img
                src="https://nauticaereso.com/wp-content/uploads/2023/03/img-partner-06.png"
                alt="agilis logo"
              />
            </div>
            <div className="slide">
              <img
                src="https://nauticaereso.com/wp-content/uploads/2023/03/img-partner-07.png"
                alt="voraz logo"
              />
            </div>
            <div className="slide">
              <img
                src="https://nauticaereso.com/wp-content/uploads/2023/01/img-partner-04.svg"
                alt="yamaha logo"
              />
            </div>
            {/* 7 MORE SLIDES */}
        ...
        <div className=" hidden lg:flex lg:justify-between lg:overflow-hidden lg:mx-10 lg:items-center lg:pb-10">
          <h1 className="font-semibold text-2xl mt-4 ml-4">Featured vessels</h1>
          <button className="hidden lg:block text-white bg-black w-[8%] h-8  text-center justify-center lg:hover:bg-red-500 ease-in-out duration-200">
            VIEW ALL
          </button>
        </div>
        {/* Popular Section */}
        <PopularSection />
        <button className="bg-black p-3 text-white w-[40%] ml-[30%] mb-60 mt-[15%] lg:hidden lg:hover:bg-red-500">
          VIEW ALL
        </button>
        {/* Promo Section*/}
        <PromoSection />
        {/* Post Preview */}
        <PostPreview />
        <div className=" hidden lg:flex lg:justify-between lg:overflow-hidden lg:mx-[3.3rem] lg:items-center  lg:mt-20">
          <h1 className="font-bold text-xl lg:text-2xl hidden lg:block">
        ...
        {/* Actual Section */}
        <ActualSection />
        <button className="bg-black p-3 text-white w-[50%] ml-[25%] lg:hidden">
          VIEW ALL
        </button>
        {/* Post Preview 2 */}
        <PostPreview2 />
        <div className=" hidden lg:flex lg:justify-between lg:overflow-hidden lg:mx-[3.3rem] lg:items-center  lg:mt-20">
          <h1 className="font-bold text-2xl lg:text-2xl hidden lg:block">
            OUR WATER SPORTS BRAND
          </h1>
          <button className="hidden lg:block text-white bg-black w-[8%] h-8  text-center justify-center lg:hover:bg-red-500 ease-in-out duration-200 ">
            VIEW ALL
          </button>
        ...
        {/* Actual Section 2 */}
        <ActualSection2 />
        <button className="bg-black p-3 text-white w-[50%] ml-[25%] mt-10 lg:hidden">
          VIEW ALL
        </button>
        {/* NEWS Section */}
        <NewsSection />
