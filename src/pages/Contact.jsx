...
import { BsFillEnvelopeFill, BsInstagram, BsFacebook, BsVimeo } from "react-icons/bs";

const Contact = () => {

  const [showSidebar, setShowSidebar] = useState(false)
  const [active, setActive] = useState('Ereso Store')
  const [location, setLocation] = useState(
    'https://nauticaereso.com/wp-content/uploads/2023/04/Map-3-1024x710.jpg'
  );
  ...
  const map = [
    "https://nauticaereso.com/wp-content/uploads/2023/04/Map-3-1024x710.jpg",
    "https://nauticaereso.com/wp-content/uploads/2023/04/Map-3-1024x710.jpg",
    "https://nauticaereso.com/wp-content/uploads/2023/04/Map-1-1024x710.jpg",
  ];
  ...
  const toggleMap = () => {
    if(active === 'Ereso Store'){
      setLocation(map[0])
    }
    if(active === 'Acastillaje'){
      setLocation(map[1])
    }
    if(active === 'Workshop'){
      setLocation(map[2])
  ...
  return (
    <>
      ...
      {/* MENU DIV FOR DESKTOP VERSION */}
      <div
        className={`top-0 w-full ease-linear duration-200 bg-white text-black absolute h-[80%] z-8 ${
      ...
      <main className="overflow-auto" onMouseEnter={() => setShowMenu(false)}>
        {/* header/navbar */}
        <div className="flex h-[8%] lg:h-[11%] w-full justify-between lg:justify-normal lg:absolute lg:p-6">
          <img
          ...
          />
          <div className="hidden md:flex font-semibold text-medium space-x-10 items-center bg-white ml-[65%] text-center w-[20%] p-4 ">
            <h1
              className="hover:text-red-500 lg:cursor-pointer ml-20"
              onMouseOver={toggleShowMenu}
            >
              Boats
            </h1>
            <h1 className="text-red-500 lg:cursor-pointer mr-20">
              <Link to="/contact">Contact</Link>
            </h1>
          </div>
        </div>
        {/* 1st section */}
        <section>
          <div className='bg-[url("https://nauticaereso.com/wp-content/uploads/2023/02/img-visual-06.jpg")] h-96 w-full bg-cover bg-center'></div>
          {/* container */}
          <div className="mx-2 lg:mx-10 mb-20 lg:mt-20">
            {/* text div */}
            <div className="text-center mt-4 mx-2 lg:flex lg:text-left lg:mb-40">
              <h1 className="text-5xl font-bold lg:w-[100%] lg:text-[5rem]">
                We are in Ibiza, are you coming to see us?
              </h1>
              <div className="text-center lg:w-[80%] lg:mt-60">
                <p className="leading-5 text-2xl font-light pt-10 lg:w-[60%]">
                  Our store is in front of Club Nautico de Ibiza. <br />
                  <br />
                  Come if you are looking for a boat, material for the practice
                  of water sports, electronic items or accessories for your
                  boat, nautical lifestyle clothing or parts and spare parts for
                  engines and navigation equipment. <br /> <br />
                  We are experts in the sea.
                </p>
              </div>
            </div>
          </div>
          {/* list items */}
          <div className="flex mx-4 justify-evenly pb-10 space-x-3 lg:w-[55%] lg:ml-auto">
          ...
          <div className="mx-4 lg:mx-10 lg:flex">
            <div className="lg:flex lg:flex-col lg:justify-end lg:pb-20 lg:pl-10 lg:w-[49rem]">
              <h1 className="text-2xl font-bold mb-4 lg:text-4xl">
                {active == buttons[0]
                  ? "We are in Ibiza"
                  : "Rigging, Rigging, Life Saving, Painting, Electricity, Cleaning and Maintenance Products"}
              </h1>
              <div className="space-y-4 lg:w-[80%]">
                <h1
                  className={`underline leading-5 text-xl lg:text-2xl font-light ${
                    active == buttons[2] && "hidden"
                  }`}
                >
                  <a href="https://www.google.es/maps/place/Avinguda+de+Santa+Eul%C3%A0ria+des+Riu,+23,+07800+Eivissa,+Illes+Balears/@38.9126934,1.4319653,17z/data=!3m1!4b1!4m6!3m5!1s0x129946b76eab96a9:0xd30ba18696c7783a!8m2!3d38.9126934!4d1.4345402!16s%2Fg%2F11c28r3y5s">
                ...
                <h1
                  className={`underline leading-5 text-xl lg:text-2xl font-light ${
                    active == (buttons[0] && buttons[1]) && "hidden"
                  }`}
                >
                  <a href="https://www.google.es/maps/place/Avinguda+de+Santa+Eul%C3%A0ria+des+Riu,+23,+07800+Eivissa,+Illes+Balears/@38.9126934,1.4319653,17z/data=!3m1!4b1!4m6!3m5!1s0x129946b76eab96a9:0xd30ba18696c7783a!8m2!3d38.9126934!4d1.4345402!16s%2Fg%2F11c28r3y5s">
                    Carretera Eivissa, Km 4,5 07817 Ibiza, Spain
                  </a>
                </h1>
                <h1
                  className={`leading-5 text-xl lg:text-2xl font-light ${
                    active == buttons[0] || (buttons[2] && "hidden")
                  }`}
                >
                  Schedule: <br />
                  M-F from 9:00 to 13:00 and 16:00 to 19:00 <br />S from 9:00 to
                  13:00
                </h1>
                <h1 className="underline text-xl lg:text-2xl font-light">
                  +34 971 314 122
                </h1>
              </div>
            </div>
            {/* MAP */}
            <div className="mt-10 h-full mx-4">
              <img src={location} alt="image" className="" />
              <img
                src="https://nauticaereso.com/wp-content/themes/ereso/images/ico-marker.svg"
                alt=""
                className="relative bottom-[13rem] left-[10.5rem]"
              />
            </div>
          </div>
        </section>
